    ...
    return (
      <TranContainer innerRef={(ref) => this.tranContainerEl = ref}>
        ...
        <ResizableDiv>
          ...
          <PointTr draggable="true" innerRef={(ref) => this.pointtrEl = ref} onMouseDown={this.handleBindResizeEvents} />
          <PointR draggable="true" innerRef={(ref) => this.pointrEl = ref} onMouseDown={this.handleBindResizeEvents} />
          <PointBr draggable="true" innerRef={(ref) => this.pointbrEl = ref} onMouseDown={this.handleBindResizeEvents} />
          <PointB draggable="true" innerRef={(ref) => this.pointbEl = ref} onMouseDown={this.handleBindResizeEvents} />
          <PointBl draggable="true" innerRef={(ref) => this.pointblEl = ref} onMouseDown={this.handleBindResizeEvents} />
          <PointL draggable="true" innerRef={(ref) => this.pointlEl = ref} onMouseDown={this.handleBindResizeEvents} />
        </ResizableDiv>
      </TranContainer>
    );
  }
