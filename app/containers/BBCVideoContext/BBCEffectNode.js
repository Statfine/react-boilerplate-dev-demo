...
export default class BBCEffectNode extends PureComponent {
  ...
  init = () => {
    const videoNode = this.ctx.video('https://cloud-clip-out2.oss-cn-shanghai.aliyuncs.com/vod-out/hd/326e9a54-ebfb-4424-8da4-934b2ddb78c6.mp4', 0, 4, { volume: 0.8, loop: false });
    videoNode.startAt(0);
    videoNode.stopAt(60);
