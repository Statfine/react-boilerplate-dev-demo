...
export default class BBCCompositingNode extends PureComponent {
  ...
  */
  init = () => {
    const videoNode1 = this.ctx.video('http://video.clip.easub.com/vod-out/hd/3236ccd2-9723-46b9-a431-8576a478fb9f.mp4', 0, 4, { volume: 0.8, loop: false });
    // 再绝对时间是的 0秒开始  10秒结束
    ...
    const videoNode2 = this.ctx.video('https://cloud-clip-out2.oss-cn-shanghai.aliyuncs.com/vod-out/hd/326e9a54-ebfb-4424-8da4-934b2ddb78c6.mp4', 0, 4, { volume: 0.8, loop: false });
    videoNode2.start(10);
    videoNode2.stop(20);
