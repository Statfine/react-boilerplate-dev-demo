...
export default class VideoTransMoreVideo extends PureComponent {
  ...
  */
  init = () => {
    const videoNode1 = this.ctx.video('http://123.206.18.31/static/video/v2.mp4', 0, 4, { volume: 0.8, loop: false });
    // 再绝对时间是的 0秒开始  10秒结束
    ...
    const videoNode3 = this.ctx.video('http://123.206.18.31/static/video/v2.mp4', 8, 4, { volume: 0.8, loop: false });
